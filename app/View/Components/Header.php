...
class Header extends Component
{
    ...
    public function render(): View|Closure|string
    {
        ...
        // то смотрим, остались ли они в БД (я их "руками" удалить или они были удалены системой из-за сомнительности таких заказов, могли быть оформлены "от балды", типа посмотреть, ф что будет, если...):
