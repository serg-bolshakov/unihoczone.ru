...
Приложение написано на PHP с использованием фреймворка Laravel и JavaScript. База данных реализована в SQLite.

## Пользовательский функционал приложения

Посетитель сайта:

- получает информацию о действующем ассортименте магазина, может просмотреть отдельные категории товары, выбрать интересующую позицию. 
